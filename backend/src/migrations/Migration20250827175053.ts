...
export class Migration20250827175053 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "user" ("id" serial primary key, "email" varchar(255) not null, "password_hash" varchar(255) null, "name" varchar(255) not null, "role" varchar(255) not null default 'user', "timezone" varchar(255) null, "reset_token" varchar(255) null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null);`);
    ...
    this.addSql(`create table "post" ("id" serial primary key, "author_id" int not null, "team_id" int null, "social_account_id" int null, "content_ar" varchar(255) not null, "content_en" varchar(255) null, "status" varchar(255) not null default 'draft', "is_recurring" boolean not null default false, "published_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "campaign_id" int null, "template_id" int null, "schedule_at" timestamptz not null);`);
    ...
    this.addSql(`create table "media" ("id" serial primary key, "post_id" int not null, "url" varchar(255) not null, "type" varchar(255) not null default 'image', "order_index" int not null default 0, "created_at" timestamptz not null);`);

    this.addSql(`create table "job" ("id" serial primary key, "post_id" int not null, "provider" varchar(255) not null default 'x', "attempt" int not null default 0, "status" varchar(255) not null default 'pending', "last_error" varchar(255) null, "scheduled_at" timestamptz not null, "executed_at" timestamptz null);`);
    ...
    this.addSql(`create table "moderation_result" ("id" serial primary key, "generation_id" int null, "post_id" int not null, "provider" varchar(255) not null default 'openai', "verdict" varchar(255) not null default 'allowed', "details" jsonb null, "checked_at" timestamptz not null);`);
