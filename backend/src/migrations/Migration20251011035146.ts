...
export class Migration20251011035146 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table "plan" ("id" serial primary key, "name" varchar(255) not null default 'Free', "price_monthly" int not null default 0, "max_accounts" int not null default 5, "ai_credits_unlimited" boolean not null default false, "ai_credits_limit" int not null, "team_collaboration" boolean not null default false, "analytics_export" boolean not null default false, "created_at" timestamptz not null);`);

    this.addSql(`create table "tag" ("id" serial primary key, "name" varchar(255) not null, "normalized" varchar(255) not null, "created_at" timestamptz not null);`);

    this.addSql(`create table "user" ("id" serial primary key, "email" varchar(255) not null, "password_hash" varchar(255) null, "name" varchar(255) not null, "role" varchar(255) not null default 'user', "timezone" varchar(255) null, "is_email_verified" boolean not null default false, "language" varchar(255) null, "locale" varchar(255) null, "time_format" varchar(255) null, "reset_token" varchar(255) null, "reset_token_expires_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null);`);
    this.addSql(`alter table "user" add constraint "user_email_unique" unique ("email");`);

    this.addSql(`create table "team" ("id" serial primary key, "name" varchar(255) not null, "owner_id" int not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null);`);

    this.addSql(`create table "template" ("id" serial primary key, "name" varchar(255) not null, "content_ar" varchar(255) not null, "content_en" varchar(255) null, "owner_id" int not null, "team_id" int null, "visibility" varchar(255) not null default 'private', "created_at" timestamptz not null, "updated_at" timestamptz not null);`);

    this.addSql(`create table "system_config" ("id" serial primary key, "value" varchar(255) not null, "description" varchar(255) null, "type" varchar(255) not null default 'string', "created_at" timestamptz not null, "updated_at" timestamptz not null, "updated_by_id" int null);`);

    this.addSql(`create table "subscription" ("id" serial primary key, "user_id" int not null, "plan_id" int not null, "status" varchar(255) not null default 'active', "period_starts_at" timestamptz not null, "period_ends_at" timestamptz not null, "canceled_at" timestamptz null, "payment_gateway_subscription_id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);

    this.addSql(`create table "social_account" ("id" serial primary key, "provider" varchar(255) not null default 'x', "provider_account_id" varchar(255) not null, "user_id" int not null, "active" boolean not null default true, "connected_at" timestamptz not null, "disconnected_at" timestamptz null);`);

    this.addSql(`create table "account_token" ("id" serial primary key, "account_id" int not null, "token_type" varchar(255) not null default 'access', "token_encrypted" varchar(255) not null, "expires_at" timestamptz null, "revoked" boolean not null default false, "created_at" timestamptz not null);`);
    ...
    this.addSql(`create table "password_reset_token" ("id" serial primary key, "user_id" int not null, "token_hash" varchar(255) not null, "used" boolean not null default false, "expires_at" timestamptz not null, "created_at" timestamptz not null);`);
    this.addSql(`create index "password_reset_token_token_hash_index" on "password_reset_token" ("token_hash");`);

    this.addSql(`create table "notification" ("id" serial primary key, "user_id" int not null, "type" varchar(255) not null default 'post_scheduled', "payload" jsonb not null, "read" boolean not null default false, "created_at" timestamptz not null, "link" varchar(255) null);`);

    this.addSql(`create table "membership" ("id" serial primary key, "user_id" int not null, "team_id" int not null, "role" varchar(255) not null default 'editor', "joined_at" timestamptz not null, "left_at" timestamptz null);`);

    this.addSql(`create table "invoice" ("id" serial primary key, "amount" int not null, "currency" varchar(255) not null default 'SAR', "status" varchar(255) not null default 'unpaid', "payment_gateway_id" varchar(255) not null, "payment_method" varchar(255) not null, "issued_at" timestamptz not null, "paid_at" timestamptz null, "downloaded_at" timestamptz null, "pdf_url" varchar(255) null, "metadata" jsonb null, "user_id" int not null, "subscription_id" int not null);`);
    ...
    this.addSql(`create table "campaign" ("id" serial primary key, "name" varchar(255) not null, "owner_id" int not null, "status" varchar(255) not null default 'active', "starts_at" timestamptz null, "ends_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);

    this.addSql(`create table "post" ("id" serial primary key, "author_id" int not null, "team_id" int null, "content_ar" varchar(255) not null, "content_en" varchar(255) null, "status" varchar(255) not null default 'draft', "is_recurring" boolean not null default false, "published_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "deleted_at" timestamptz null, "campaign_id" int null, "template_id" int null, "schedule_at" timestamptz not null);`);
    this.addSql(`create index "post_schedule_status_idx" on "post" ("schedule_at");`);

    this.addSql(`create table "post_target" ("id" serial primary key, "post_id" int not null, "social_account_id" int not null, "status" varchar(255) not null default 'pending', "attempt" int not null default 0, "last_error" varchar(255) null, "external_post_id" varchar(255) null, "external_url" varchar(255) null, "scheduled_at" timestamptz null, "published_at" timestamptz null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
    ...
    this.addSql(`create table "post_tag" ("id" serial primary key, "post_id" int not null, "tag_id" int not null, "created_at" timestamptz not null);`);

    this.addSql(`create table "post_analytics" ("id" serial primary key, "post_id" int not null, "impressions" int not null default 0, "clicks" int not null default 0, "likes" int not null default 0, "comments" int not null default 0, "shares" int not null default 0, "fetched_at" timestamptz not null);`);
    this.addSql(`create index "post_analytics_post_time_idx" on "post_analytics" ("post_id");`);

    this.addSql(`create table "media" ("id" serial primary key, "post_id" int null, "url" varchar(255) not null, "type" varchar(255) not null default 'image', "order_index" int not null default 0, "created_at" timestamptz not null);`);

    this.addSql(`create table "job" ("id" serial primary key, "post_id" int not null, "target_id" int null, "provider" varchar(255) not null default 'x', "attempt" int not null default 0, "status" varchar(255) not null default 'pending', "last_error" varchar(255) null, "scheduled_at" timestamptz not null, "executed_at" timestamptz null);`);

    this.addSql(`create table "generation" ("id" serial primary key, "post_id" int not null, "prompt" varchar(255) not null, "text" varchar(255) not null, "dialect" varchar(255) not null default 'MSA', "tone" varchar(255) not null default 'casual', "generated_at" timestamptz not null, "updated_at" timestamptz not null);`);

    this.addSql(`create table "moderation_result" ("id" serial primary key, "generation_id" int null, "post_id" int not null, "provider" varchar(255) not null default 'gemini', "verdict" varchar(255) not null default 'allowed', "details" jsonb null, "checked_at" timestamptz not null);`);

    this.addSql(`create table "audit_log" ("id" serial primary key, "user_id" int not null, "action" varchar(255) not null, "entity_type" varchar(255) not null, "entity_id" varchar(255) not null, "details" jsonb null, "timestamp" timestamptz not null);`);
    ...
    this.addSql(`create table "webhook_subscription" ("id" serial primary key, "user_id" int not null, "url" varchar(255) not null, "event" varchar(255) not null default 'post.published', "active" boolean not null default true, "secret_encrypted" varchar(255) not null, "created_at" timestamptz not null);`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "ai_usage_log" drop constraint "ai_usage_log_user_id_foreign";`);
    ...
    this.addSql(`alter table "ai_usage_log" drop constraint "ai_usage_log_subscription_id_foreign";`);
    ...
    this.addSql(`alter table "ai_usage_log" drop constraint "ai_usage_log_generation_id_foreign";`);
